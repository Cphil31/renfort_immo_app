...
class ProfessionController extends AbstractController
{
    ...
    {
        $profession->setContact($profession->getContact());
        $profession->setEntreprise($profession->getEntreprise());
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_entreprise_edit', ['id' => $profession->getEntreprise()->getId()], Response::HTTP_SEE_OTHER);
        }
