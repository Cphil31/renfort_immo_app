...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 15 nov. 2023 à 09:10
...
(4, 8, 1, '2023-10-24 15:04:00', 'hello', 0);
...
INSERT INTO `contact` (`id`, `nom`, `prenom`, `statut_id`, `entreprise`, `poste`) VALUES
(1, 'Cecile', 'Philippe', 1, NULL, NULL),
(2, 'Sanachy', 'Patrice', 4, NULL, NULL),
(3, 'Firmin', 'Patrice', 1, 'FOCUS SARL', NULL),
(4, 'Baba', 'Ali', 2, NULL, NULL),
(5, 'CECILE', 'Arsene', 1, NULL, NULL),
(6, NULL, NULL, NULL, 'FOCUS', NULL),
(7, NULL, NULL, 1, 'isc', NULL),
(8, 'Sanachy', 'Sébastien', 1, NULL, NULL);
...
('DoctrineMigrations\\Version20231024145337', '2023-10-24 14:53:48', 149);
...
(3, 3, 2, '2023-07-05 00:00:00', 'fdsssd'),
(5, 1, 2, '2023-07-12 00:00:00', NULL),
(6, 14, 2, '2023-06-30 00:00:00', 'sdfsdfsd'),
(8, 1, 2, '2023-07-04 00:00:00', 'dgdfgfd'),
(11, 2, 3, '2023-07-04 00:00:00', 'pas d\'électicité');
...
(1, 3, NULL, NULL, 'Pas encore de contact', 'contact', '2023-07-20 13:21:27'),
(2, NULL, NULL, 2, 'Bonjour a vous', 'Histoire 1', '2023-11-15 08:41:05');
...
(4, 1, 2, NULL, 2, 'hello', '10.00', '2023-07-05 14:51:00', NULL, '00:10:00', 0, NULL),
(5, 2, 5, NULL, 3, NULL, '10.00', '2023-07-13 15:19:00', 'pose des bornes', '00:50:00', 1, NULL),
(6, 1, 1, NULL, 4, NULL, '10.00', '2023-08-23 16:13:00', 'nul en code', '00:13:00', 0, NULL);
...
INSERT INTO `mail` (`id`, `statut_id`, `contact_id`, `entreprise_id`, `mission_id`, `email`, `objet`, `content`, `created_at`) VALUES
(1, 1, 1, NULL, NULL, 'cecilephilippe31@gmail.com', NULL, NULL, NULL);
...
(1, 4, NULL, 'Larra - 1', 'Larra1', 'Larra', 'LMD'),
(2, 1, NULL, 'Toulouse', 'toulouse1', 'toulouse', 'a vendre'),
(3, 4, NULL, 'Mairie 1', NULL, NULL, NULL);
...
(3, NULL, NULL, 'Chateau Merville', NULL, NULL, NULL, NULL, NULL, 'Tout a refaire'),
(4, 6, 3, 'Maire de toulouse', 'Toulouse', NULL, NULL, NULL, NULL, NULL);
...
(1, 3, NULL, 1, '+33 7 89 54 86 28', NULL);
...
(1, 'tom@tom.fr', '[\"ROLE_USER\"]', '$2y$13$Bo55lkl5bwOJ/qPb2h/0yeHHTqvB/TklCXYv8JFYBvyiTUiFHj6Ca', 'Tom', 'Tom', NULL),
(2, 'phil31780@live.fr', '[\"ROLE_PATRON\"]', '$2y$13$4k2g9jAlmLv0a5304mhf5OCgyhTUP6ThHxpolYdCX9BDw9E/Pbauy', 'Cecile', 'Philippe', 'QS7pNNAh5zsU4y6b-IyzFaEzecTLRk-Hs6yDLz_mgQ0'),
(3, 'ali@baba.fr', '[\"ROLE_USER\"]', '$2y$13$d5vBinEE.0sfSpUdnDkjUOGEA3sOwivMibPDZWdqXYdfLdUjsHfam', 'Baba', 'Ali', NULL),
(4, 'cecilephilippe31@gmail.com', '[\"ROLE_USER\"]', '$2y$13$48/EFFxOcJvd2KYm7YUWY.GTZQyzEeZiQ/JdCiuppOK4I/si1oHK6', 'Cecile', 'Philippe', '-67UeREROp4sA1bFfHY6EQQBdgbK6v8RN7ekbbUg1Wo');
