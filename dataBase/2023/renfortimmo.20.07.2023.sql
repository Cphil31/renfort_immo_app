...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 20 juil. 2023 à 13:33
...
INSERT INTO `contact` (`id`, `nom`, `prenom`, `statut_id`, `entreprise`) VALUES
(1, 'Cecile', 'Philippe', 1, NULL),
(2, 'Sanachy', 'Patrice', 4, NULL),
(3, NULL, NULL, 1, 'FOCUS');
...
('DoctrineMigrations\\Version20230720123541', '2023-07-20 12:35:50', 128);
