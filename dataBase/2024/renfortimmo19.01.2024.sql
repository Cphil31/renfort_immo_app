...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 19 jan. 2024 à 15:14
...
INSERT INTO `deplacement` (`id`, `tache_id`, `statut_id`, `lieu`, `date`, `duree`, `cout`, `cout_peage`, `cout_carburant`, `observation`, `payer`, `kilometrage_depart`, `kilometrage_arrive`) VALUES
(1, 1, 1, 'Aucamville', '2024-01-19 12:39:27', '00:39:00', 10.00, NULL, NULL, NULL, 0, 150000, 150020);
...
('DoctrineMigrations\\Version20240119121301', '2024-01-19 12:13:18', 180),
('DoctrineMigrations\\Version20240119145734', '2024-01-19 14:57:45', 478);
...
INSERT INTO `tache` (`id`, `probleme_id`, `statut_id`, `description`, `date`, `owner_id`) VALUES
(1, 1, 1, 'Rendez vous chez le notaire', '2023-11-17 11:43:00', NULL),
(2, 1, 2, 'courir cet aprem midi', '2023-11-17 11:59:00', NULL),
(3, 1, 1, 'caca', '2024-01-19 16:05:00', 1),
(4, 1, 1, 'caca poule', '2024-01-19 16:09:00', 3);
...
(3, 'cecilephilippe@gmail.com', '[\"ROLE_USER\"]', '$2y$13$0TOGI5hxMQDQpqKS7OwpC.LVYDNxlEzmYeRCH0gRyvl/KTxL2LANu', 'Cecile', 'Philippe', NULL);
